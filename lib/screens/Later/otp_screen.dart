...
class OtpVerificationScreen extends StatefulWidget {
  ...
  /// trigger a network request if desired.  If not supplied the resend
  /// button simply resets the timer and shows a success message locally.
  final Future<void> Function()? resendCallback;
...
class _OtpVerificationScreenState extends State<OtpVerificationScreen>
  ...
  Future<void> _handleVerifyOtp() async {
    ...
    // pop returning true so caller can act accordingly
  ...
  Future<void> _handleResendOtp() async {
    ...
    if (widget.resendCallback != null) {
      try {
        await widget.resendCallback!();
      } catch (_) {}
    }
  ...
  Widget _buildOtpField(int index) {
    ...
    return AnimatedContainer(
      ...
      width: 48, // Slightly reduced to ensure it fits well on smaller screens
      height: 56,
      decoration: BoxDecoration(
